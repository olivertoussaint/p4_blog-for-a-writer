  ...
  <html lang="fr">
     <head>
        ...
        <link type="text/css" rel="stylesheet" href="./public/css/assets/materialize.css"  media="screen,projection"/>   
     </head>
     ...
     <body> 
      ...
      <?php require('public/template/footer.php'); ?>                   
        ...
        <script type="text/javascript" src="./public/js/assets/materialize.js"></script>
     </body>
  </html>